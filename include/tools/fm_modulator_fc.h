...
namespace gr {
    ...
    public:
        ...
        */
        static sptr make(float samp_rate, float deviation, float initial_phase);

        virtual void set_freq_deviation(float deviation) = 0;
        virtual float freq_deviation() const = 0;
    };
